...
$ssmenu3 = "Mes Groupes";
$menu3 = "CLUB";
$ssmenu4 = "Voir la liste des Clubs";
$ssmenu5 = "Ajout d'un Club";
$menu4 = "RECHERCHER";
...
$formclub19 = "Ajouter une photo :";
//
$ajoutfaq = "Ajouter une Question à la FAQ";
$redques = "Rédigez une question pour la FAQ";
$indrep = "Indiquez la réponse";
//
$neplusrej = "Vous ne rejoindrez plus automatiquement le groupe ";
$redir = "Vous allez être redirigé vers vos groupes.";
//
$motfond = "Mot des fondateurs : ";
$motcontenu1 = "Semi professionnel, sportif occasionnel ou encore golfeur du dimanche, tout le monde préfère faire du sport avec des amis. S’il est plus agréable de courir à plusieurs, il est tout simplement indispensable d’avoir des partenaires pour un sport collectif. Malheureusement, il n’est pas toujours évident de trouver 21 amis pour un match de footbal, et encore moins 29 connaissances pour un rugby du samedi…  C’est pour cela que nous avons imaginé TeamHub. D’ici peu, TeamHub va révolutionner votre pratique du sport.";
$motcontenu2 = "Grâce à TeamHub, vous allez rencontrer des sportifs près de chez vous et de votre niveau. Organisez ou participez aux activités proposées par vos groupes. Réassemblez et fédérez une communauté de passionnés autour de votre sport préféré.";
$motcontenu3 = "Adhérez TeamHub, choisissez la facilité.";
$presequ = "Présentation de l'équipe:";
//
$ba = "Vous avez été Banni !";
$contactadmi = "Si vous souhaitez plus de détails contactez l'administrateur du site.";
//
$selectadmin = "Selectionnez un membre à bannir";
$mban = "Membres Bannis";
//
...
$vues = "Vues";
//vueClub
$dercomm = "Les derniers commentaires";
$riencomm = "Il n'y a pas encore de commentaire ... ";
$bestcomm = "Les meilleurs commentaires";
$wcomm = "Les moins bons commentaires";
$notecomm = "Notez et Commentez ce club !";
$ajcomm = "Ajoutez un commentaire !";
...
//
$clubcree = "Ce Club a bien été créé !";
//
$partiok = "Vous participez à ";
//
$appartok = "Bienvenue dans le groupe ";
//
