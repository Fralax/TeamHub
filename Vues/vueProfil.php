			...
			<div class="conteneur">
				...
				<div class="mesInfos">
			      ...
			      <p> Email : <?php echo $infos[u_email]?> </p>
					...
					<div class="modifs">
						<a href="index.php?page=modifmonadresse&nom=<?php echo $_SESSION[pseudo] ?>"><h3>Modifier ma Localisation</h3></a>
						<a href="index.php?page=modifmescoordonnees&nom=<?php echo $_SESSION[pseudo] ?>"><h3>Modifier mes Coordonnées</h3></a>
						<a href="index.php?page=ajoutsport&nom=<?php echo $_SESSION[pseudo] ?>"><h3>Ajouter un Sport</h3></a>
						<a href="index.php?page=modifmonmdp&nom=<?php echo $_SESSION[pseudo] ?>"><h3> Modifier mon Mot de Passe </h3></a>
					</div>
				</div>
			</div>
 		<?php } ?>
