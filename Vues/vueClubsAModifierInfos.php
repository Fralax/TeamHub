<?php $this->titre = $vueClubsAModifierCommentaires;
    ...
    <?php foreach ($listeClubs as list($nomclubs)) { ?>
			<table>
				<tr>
					...
					<td> <a href="index.php?page=modifclub&club=<?php echo $nomclubs?>" > <input type="button" name="Modifier" value="<?php echo $mod ?>"> </a> </td>
				</tr>
			</table>
    <?php } ?>
	<?php } ?>
