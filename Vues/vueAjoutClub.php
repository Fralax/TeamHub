...
$this->titre = $vueAjoutClub;?>
		...
		<div class="formulaireAjoutClub">
			...
			<form name = "formulaireNouveauClub" method="post" action = "" enctype="multipart/form-data" >
				<div class="ChampAjoutClub">
					<table>
					<tr>
						<td>
							<input type="text" name="nomClub" placeholder="<?php echo $formclub1 ?>" size="25" value = "<?= $_POST['nomClub'] ?>"/>
						</td>
					</tr>
					<tr>
						<td>
							<input type="text" name="adresseClub" placeholder="<?php echo $formclub2 ?>" size="25" value = "<?= $_POST['adresseClub'] ?>"/>
						</td>
					</tr>
					<tr>
						<td>
							<input type="text" name="cpClub" placeholder="<?php echo $formclub3 ?>" size="25" value = "<?= $_POST['cpClub'] ?>"/>
						</td>
					</tr>
					<tr>
						<td>
							<input type="text" name="numeroClub" placeholder="<?php echo $formclub4 ?>" size="25" value = "<?= $_POST['numeroClub'] ?>"/>
						</td>
					</tr>
					<tr>
						<td>
			...
			<div class="horaireAjoutClub">
				<table>
					<tr>
						<td>
							<?php echo $formclub8.$formclub7 ?>
						</td>
						<td>
			...
			<div class="ChampAjoutClub">
				<table>
					<tr>
						<td>
							<label for="remarqueHoraire"> <?php echo $formclub17 ?> </label>
						</td>
					</tr>
					<tr>
						<td>
				        <textarea name="remarqueHoraire" cols="50" rows="3"> </textarea>
						</td>
					</tr>
					<tr>
						<td>
							<label for="photo"> <?php echo $formclub19 ?> </label>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<input name="ajouter" type="submit" value="<?php echo $ajo ?>">
						</td>
					</tr>
				</table>
			</div>
