...
class forum extends modele {
  ...
  public function creerSujet($categorie){
    $dateA = date('Y-m-d');
    $heureA = date('H:i');
    $sql = 'INSERT INTO teamhubp_teamhub.sujetForum(f_categorie, f_sujet, f_date, f_heure, f_auteur, f_nombreReponses, f_actif) VALUES (:categorieSujet, :nomSujet, :dateSujet, :heureSujet, :auteurSujet, :nombreReponsesSujet, activiteSujet)';
