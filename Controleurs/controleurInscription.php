...
require_once 'Vues/vue.php';
 ...
 class inscription{
   ...
   public function verif(){
     ...
     if(isset($envoyer)){
       if (($nom != "") && ($prenom != "") && ($sexe != "") && ($_POST['cp'] != "") && ($email != "") && ($confirmEmail != "") && ($pseudo != "") && ($motDePasse != "") && ($confirmMotDePasse != "")){
         if($_POST['cgu'] == "cgu"){
      ...
      Ceci est un mail automatique, Merci de ne pas y répondre.";
           ...
           if($_COOKIE['langue'] == "English"){
             ?> <script> alert("You haven't accepted the conditions of use !")</script> <?php
           } else {
             ?> <script> alert("Vous n'avez pas accepté les conditions d'utilisations !")</script> <?php
           }
         }
       }
