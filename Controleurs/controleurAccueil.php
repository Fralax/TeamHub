...
class accueil{
  ...
  public function affichageAccueil(){
    ...
    $vue->generer(array("groupes" => $afficherMesGroupes, 'invit'=>$invitations, 'acq'=>$acquittement, 'notif'=>$notification, "evenements" => $afficherEvenements, "suggestiongroupes"=>$afficherSugestionGroupes, "departement"=>$departement, "sport"=>$sports, "suggestionsports"=>$afficherSugestionSports));
  }
