...
function ajoutUtilisateurBdd(){
    ...
    $req = $bdd->prepare('INSERT INTO Utilisateurs(u_pseudo, u_nom, u_prenom, u_adresse,
                                            u_ville, u_cp, u_region, u_portable, u_email, u_naissance, u_mdp, u_sexe)
                  VALUES (:pseudo, :nom, :prenom, :adresse, :ville, :cp, :departement, :portable, :email, :naissance, :mdp, :sexe)');
    $req-> execute(array(
      'pseudo' => $_POST['Pseudo'],
      'nom' => $_POST['Nom'],
      'prenom' => $_POST['Prenom'],
